...
<span class="v" onclick="location.href='Rechercher.php'" style="cursor:pointer;">Rechercher</span><span id="c" onclick="location.href='Rechercher.php'" style="cursor:pointer;" > un film</span>
<div id="rechercher" onclick="location.href='Rechercher.php'" style="text-align:right;color:white;cursor:pointer;margin-right:130px;font-weight:bold;text-decoration:underline;">Rechercher un film</div>
</div>
...
<br><br>
<div id="champ">Rechercher un film:<br>
		<form> 
